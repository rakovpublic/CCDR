...
def main():
    parser = base_argparser("T26: fusion ELM energy scaling")
    args = parser.parse_args()
    try:
        result = run_test("T26", args)
    except Exception as exc:
        result = wrap_error("T26", exc)
    emit_result(result, args.outdir, "T26")
