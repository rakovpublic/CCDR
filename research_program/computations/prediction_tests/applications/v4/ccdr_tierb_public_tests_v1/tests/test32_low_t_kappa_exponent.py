...
def main():
    parser = base_argparser("T32: low-T kappa exponent")
    args = parser.parse_args()
    try:
        result = run_test("T32", args)
    except Exception as exc:
        result = wrap_error("T32", exc)
    emit_result(result, args.outdir, "T32")
