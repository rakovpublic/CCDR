...
def main():
    parser = base_argparser("T59: public HEP anomaly ledger")
    args = parser.parse_args()
    try:
        result = run_test("T59", args)
    except Exception as exc:
        result = wrap_error("T59", exc)
    emit_result(result, args.outdir, "T59")
