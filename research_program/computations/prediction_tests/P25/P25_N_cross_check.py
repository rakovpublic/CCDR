...
print("-" * 60)
Omega_ratio = 5.0  # Omega_DM / Omega_B
k_eff = 1 / (Omega_ratio + 1)
print(f"Omega_DM/Omega_B = {Omega_ratio}")
print(f"k_eff = 1/(Omega_DM/Omega_B + 1) = {k_eff:.4f}")
...
# the bulk is a discretised hyperbolic 2-space (H^2)
# For the full 3D holographic code:
# the bulk is a discretised H^3
...
# The HaPPY code rate k/n -> 0 as N -> inf unless N_internal
