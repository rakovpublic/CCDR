...
META = {
  ...
  "implementation_notes": [
    "Consumes future event-level peak candidates; current public limits are not peak detections."
  ],
  "kind": "direct_detection_window_dashboard",
  "prediction_id": "P27",
  "prediction_name": "P27 direct-detection mass-window sensitivity dashboard",
  "sources": [],
  "test_id": "R10-T28",
  "tier": "public-current"
}
