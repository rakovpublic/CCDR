...
META = {
  ...
  "implementation_notes": [
    "Requires event-level direct-detection samples or time-sliced public likelihoods."
  ],
  "kind": "dm_phase_event_ready",
  "prediction_id": "P37",
  "prediction_name": "P37 DM phase-space drift event-level readiness positive",
  "sources": [],
  "test_id": "R10-T29",
  "tier": "public-current"
}
