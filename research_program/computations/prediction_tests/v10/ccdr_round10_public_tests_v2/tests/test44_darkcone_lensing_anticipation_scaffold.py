...
META = {
  ...
  "implementation_notes": [
    "Needs time-ordered baryon-density and lensing maps; current public catalogues permit only static proxy tests."
  ],
  "kind": "darkcone_lensing_branch",
  "prediction_id": "Dark-Cone",
  "prediction_name": "Dark-Cone lensing anticipation branch-survival positive",
  "sources": [],
  "test_id": "R10-DC01",
  "tier": "public-proxy"
}
